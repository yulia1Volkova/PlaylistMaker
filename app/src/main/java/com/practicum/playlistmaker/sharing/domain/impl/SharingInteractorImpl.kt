...
private const val MAIL_MESSAGE = "Сообщение разработчикам и разработчицам приложения Playlist Maker"
...
class SharingInteractorImpl(
  ...
  private fun getShareAppLink(): String =APP_LINK
    ...
    private fun getSupportEmailData(): EmailData = EmailData(SUPPORT_EMAIL,MAIL_MESSAGE)
